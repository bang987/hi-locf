...
public class LocfBatchRunResponse {
    ...
    public LocfBatchRunResponse() {
    }

    public LocfBatchRunResponse(String batchRunNo, LocalDate baseDate, String statusCode, long targetCount,
