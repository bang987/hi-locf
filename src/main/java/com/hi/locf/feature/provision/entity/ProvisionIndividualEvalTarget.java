...
public class ProvisionIndividualEvalTarget {
    ...
    public ProvisionIndividualEvalTarget() {
    }

    public ProvisionIndividualEvalTarget(Long individualTargetId, LocalDate baseDate, Long contractId,
            String contractNo, String customerName, String productCode, String evalReasonCode,
