...
public class ProvisionBatchStepExecution {
    ...
    public static ProvisionBatchStepExecution start(Long batchExecutionId, String stepName) {
        ProvisionBatchStepExecution step = new ProvisionBatchStepExecution();
